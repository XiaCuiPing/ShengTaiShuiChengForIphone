...
- (instancetype)init{
    if (self = [super init]) {
        ...
        [weixinButton setImage:[NSBundle imageWithBundleName:@"DSXUI" imageNamed:@"weixin.png"] forState:UIControlStateNormal];
        ...
        [pengyouquanButton setImage:[NSBundle imageWithBundleName:@"DSXUI" imageNamed:@"pengyouquan.png"] forState:UIControlStateNormal];
        ...
        [qqButton setImage:[NSBundle imageWithBundleName:@"DSXUI" imageNamed:@"qq.png"] forState:UIControlStateNormal];
        ...
        [qzoneButton setImage:[NSBundle imageWithBundleName:@"DSXUI" imageNamed:@"qzone.png"] forState:UIControlStateNormal];
        ...
        [copyButton setImage:[NSBundle imageWithBundleName:@"DSXUI" imageNamed:@"copy.png"] forState:UIControlStateNormal];
